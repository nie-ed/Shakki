class Queen:
    """Class, which checks the possible moves of a queen piece, and adds them to a list.
    ...
    def queen_movement(self, board, row, col, self_pieces):
        ...
        Args:
            ...
            self_pieces (list): Alphabetic symbol for own pieces in a list

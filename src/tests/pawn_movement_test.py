...
class TestPawn(unittest.TestCase):
    ...
    def test_own_pawn_cannot_move(self):
        ...
        row = 8
        col = 4
        legals_in_position = self.pawn.pawn_movement(test_board, row, col, self.opponent_pieces, True)
    ...
    def test_opponent_pawn_cannot_move(self):
        ...
        row = 1
        col = 4
        legals_in_position = self.pawn.pawn_movement(test_board, row, col, self.pieces, False)
        self.assertEqual([], legals_in_position)
    ...
    def test_opponent_pawn_can_move_one_up(self):
        ...
        legals_in_position = self.pawn.pawn_movement(test_board, row, col, opponent_pieces, False)

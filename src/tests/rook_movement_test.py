...
class TestRook(unittest.TestCase):
    ...
    def test_rook_cannot_move(self):
        ...
        row = 8
        col = 4
        legals_in_position = self.rook.rook_movement(test_board, row, col, self.pieces)
    ...
    def test_rook_can_move_anyway_also_on_opponent_piece(self):
        ...
        col = 4
        legals_in_position = self.rook.rook_movement(test_board, row, col, self.pieces)
        self.assertCountEqual([(4, 4), (3, 4), (2, 4), (5, 3), (5, 2), (5, 1), (5, 0), (5, 5), (5, 6), (5, 7), (6, 4), (7, 4), (8, 4)], legals_in_position)
